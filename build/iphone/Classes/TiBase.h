...
// in simulator we redefine to format for FieldMate Developer console
...
{\
	NSString * exceptionName = [@"org.fieldmate." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fieldmate";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIFieldMateNativeItemNone = -1, 
	UIFieldMateNativeItemSpinner = -2,
	UIFieldMateNativeItemProgressBar = -3,
	
	UIFieldMateNativeItemSlider = -4,
	UIFieldMateNativeItemSwitch = -5,
	UIFieldMateNativeItemMultiButton = -6,
	UIFieldMateNativeItemSegmented = -7,
	
	UIFieldMateNativeItemTextView = -8,
	UIFieldMateNativeItemTextField = -9,
	UIFieldMateNativeItemSearchBar = -10,
	
	UIFieldMateNativeItemPicker = -11,
	UIFieldMateNativeItemDatePicker = -12,
	
	UIFieldMateNativeItemInfoLight = -13,
	UIFieldMateNativeItemInfoDark = -14,
	
	UIFieldMateNativeItemDisclosure = -15,
	
	UIFieldMateNativeItemContactAdd = -16
};

...
@interface FieldMateObject : NSObject
@end

@interface FieldMateObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FieldMateObject class]])
		{
			for (NSString *key in [[(FieldMateObject*)o modules] allKeys])
			{
